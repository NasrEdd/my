...
export class PlanificationPageComponent implements OnInit {
  ...
  StepperConfig: { PageTitle: string, StepTitle: string, isValide: boolean, isComplete: boolean, isDisable: boolean }[] =
    [
      ...
      { PageTitle: "Importation des fichiers EXCEL", StepTitle: "Importation", isValide: true, isComplete: true, isDisable: false },
      { PageTitle: "Resultat Pre-Traitement", StepTitle: "PréTraitement", isValide: true, isComplete: true, isDisable: false },
      { PageTitle: "Lancement de l'algorithme", StepTitle: "Lancement", isValide: true, isComplete: true, isDisable: false },
      { PageTitle: "Meilleurs planifications", StepTitle: "Planifications", isValide: true, isComplete: true, isDisable: false },
